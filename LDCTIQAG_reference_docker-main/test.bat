...
docker run --rm -v iqaregression-output:/home/jongtak/Desktop/grand_challenge/pre_train/LDCTIQAG_reference_docker-main/output/ python:3.7-slim cat /home/jongtak/Desktop/grand_challenge/pre_train/LDCTIQAG_reference_docker-main/output/image-quality-scores.json | python -m json.tool
